/** 플래닉 로고 마크(아이콘) - 앱 쉘 공용 소스 */

export function PlanicMark({
  size,
  className = '',
}: {
  size: number
  ...
  // next/og의 아이콘 구성(app/icon.tsx, app/apple-icon.tsx)과 동일한 비율로 맞춤
  // (280x280에서 borderRadius=112, inset=32, highlightRadius=96)
  const outerRadius = size * 0.4
  const inset = size * 0.1142857143
  const highlightRadius = size * 0.3428571429
