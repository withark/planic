...
export default function PlanningGeneratorPage() {
  ...
  }, [doc, requestBaseFromDoc, showToast, sourceMode, taskOrderSummary, topic, goal, notes, headcount, venue, startSession, stillCurrent, clearAbortIfCurrent, flushQueuedIntoNotes])
