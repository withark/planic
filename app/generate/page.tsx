      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-slate-50/50">
        {isGenerating && (
          <div className="flex items-center gap-2 px-4 py-2 text-xs text-primary-800 bg-primary-50 border-b border-primary-100">
            ...
            <span>에브쿼트가 견적서·기획안을 생성 중입니다: {statusMsg || '분석 중...'}</span>
          </div>
        )}
        {isGenerating ? (
          <div className="flex flex-col items-center justify-center h-full gap-3 text-center px-6">
            ...
            <div className="space-y-1">
              <p className="text-base font-medium text-gray-700">에브쿼트가 새 견적서·기획안을 만드는 중입니다</p>
          ...
          <div className="flex flex-col items-center justify-center h-full gap-4 text-center px-6">
            <div className="w-16 h-16 rounded-2xl bg-primary-100 flex items-center justify-center">
              <span className="text-2xl font-light text-primary-600">에브쿼트</span>
            </div>
            <div className="space-y-1">
              <p className="text-base font-medium text-gray-700">에브쿼트가 만든 견적서·기획안이 여기에 표시됩니다</p>
              <p className="text-sm text-gray-500">
                왼쪽에 행사 기본 정보를 입력한 뒤 「에브쿼트로 견적서 · 기획안 생성하기」를 누르거나, 비슷한 행사가 있으면 기존 견적서를
                불러와 수정하세요.
              </p>
            </div>
