      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4">
            <ActionButton href="/estimate-generator" title="견적서 만들기" desc="견적서 생성" />
            <ActionButton href="/planning-generator" title="기획안 만들기" desc="기획 문서 생성" />
            <ActionButton href="/program-proposal-generator" title="프로그램 제안서 만들기" desc="프로그램 제안서 생성" />
            <ActionButton href="/scenario-generator" title="시나리오 만들기" desc="시나리오 생성" />
            <ActionButton href="/cue-sheet-generator" title="큐시트 만들기" desc="큐시트(운영표) 생성" />
            <ActionButton href="/task-order-summary" title="과업지시서 요약하기" desc="과업지시서 요약 생성" />
          </div>
        </div>
      </div>
    </div>
