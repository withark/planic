        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 max-w-2xl">
          ...
          <section className="bg-white border border-gray-100 rounded-xl overflow-hidden shadow-card">
            <div className="px-4 py-3 bg-primary-50/50 border-b border-gray-100">
              ...
              <p className="text-xs text-gray-400 mt-0.5">견적서 파일을 올리면 AI가 구성·단가를 학습하고, 단가표에 자동 반영합니다. 업로드·관리는 왼쪽 메뉴 「참고」에서 하세요.</p>
              <Link href="/references" className="inline-block mt-2 text-xs font-medium text-gray-600 hover:text-gray-900 underline">
                참고 견적서 메뉴로 이동 →
              </Link>
            </div>
          </section>
